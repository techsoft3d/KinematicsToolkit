...
async function msready() {
    ...
    KT.KinematicsManager.disableComponentMoveOperator();
...
function createUILayout() {
    ...
    var viewermenu = [
        ...
        {
            name: 'Disable Component Move Op.',
            fun: function () {
                KT.KinematicsManager.disableComponentMoveOperator();
        ...
        {
            name: 'Enable Enforce Limits',
            fun: function () {
                currentHierachy.setEnforceLimits(true);

            }
        },
        {
            name: 'Disable Enforce Limits',
            fun: function () {
                currentHierachy.setEnforceLimits(true);
            }
        },
